...
import { getContestHistory } from "./utils"
...
function TableRow({
  ...
  return (
    <div className="table-row">
      ...
      <Cell_Rating rating={r1} />
      <Cell_Rating rating={r2} />
      <Cell_Rating rating={r3} />
      <Cell_Rating rating={r4} />
    ...
    async function run() {
      ...
      const newRows = result.map((contest, idx) => (
        <TableRow
          ...
          ID={contest.id}
          Date={contest.start_time} // ⚠️ fix field name
          Level={contest.selected_level} // ⚠️ fix field name
          r1={contest.r1}
          r2={contest.r2}
          r3={contest.r3}
          r4={contest.r4}
          status1={contest.status1}
          status2={contest.status2}
          status3={contest.status3}
          status4={contest.status4}
          perf={contest.perf}
